        ...
        <div className={styles.blogContainer}>
          <div className={styles.blogHeader}>
            ...
            <div className={styles.blogNav}>
              <div className={styles.blogNavItems}>
                ...
                <div className={styles.blogNavItem}>
                  <Link className={styles.blogNavH} href="/about">
                    About us
                  </Link>
                </div>
                <div className={styles.blogNavItem}>
          ...
          <div className={styles.brand}>
            <div className={styles.brandLeft}>
              <h3>Trusted by brands all over the world</h3>
              <p>
                We are proud to have worked with top brands all across the world
          ...
          <div className={styles.consultingAreContainer}>
            {" "}
            <div className={styles.consultingAre}>
              <h2>360º Digital Commerce Consulting</h2>
              <div className={styles.areasRow}>
                <div className={styles.areaBlock}>
                  <img src="image 10.svg"></img>
                  <h3>Product Management</h3>
                  <p>
                    We combine business, tech, and design in order to discover
                    products that are valuable, feasible, and usable.
                  </p>
                </div>
                <div className={styles.areaBlock}>
                  ...
                  <p>
                    We help you in mapping your target customers with delightful
                ...
                <div className={styles.areaBlock}>
                  ...
                  <p>
                    We help organizations define, visualize & communicate the
                    digital strategy, convert it into tangible roadmaps.
                  </p>
                </div>
                <div className={styles.areaBlock}>
                  ...
                  <h3>MVPs</h3>
                  <p>
                    We create lean, highly effective MVP experiments. Testing
                    with real people against actual problems to ensure your core
              ...
              <div className={styles.areasRow}>
                <div className={styles.areaBlock}>
                  ...
                  <h3>DevSecOps</h3>
                  <p>
                    Transformation plan for delivering DevOps culture and
                    building a sustainable delivery organization through
                ...
                <div className={styles.areaBlock}>
                  ...
                  <h3>Technology</h3>
                  <p>
                    We provide technology strategy fitting your digital
                    transformation strategy supporting cloud strategy,
                    application modernization, scalable digital architecture and
                    solution designs.
                  </p>
                </div>
              </div>
          ...
          <div className={styles.global}>
            ...
            <div className={styles.globalRight}>
              ...
              <p>
                <b>-{"  "}</b> Experienced Partners who have designed,
                architected & delivered top-notch digital experiences globally.
              </p>
              <p>
                <b>-{"  "} </b>Strategize, Define and Operate your digital
                transformation roadmap
              </p>
              <p>
                <b>-{"  "}</b>Focus on delivering tangible value over advisory.
              </p>
              <p>
                <b>-{"  "}</b> Presence in the UAE, EU, INDIA & US.
              </p>
            </div>
          </div>
